...
public final class ReflexaoUtils {
	 ...
	 * @param parametros - Parâmetros que o metodo espera (Caso não exista, deve-se passar
	 * null).
	 * @return Retorna o retorno do metodo que será executado (Caso seja void irá retornar
	 * null).
	 * @throws Exception
	 ...
	 * @param parametros - Parametros que o metodo espera (Caso não exista, deve-se passar
	 * null).
	 * @return Retorna o retorno do metodo que será executado (Caso seja void irá retornar
	 * null).
	 * @throws Exception
	...
	private static Object invokeMethod(Class<?> classe, Object entidade, String nomeMetodo, Object[] parametros,
		...
		if (metodo == null) {
			throw new NoSuchMethodException("ReflexaoUtils.invokeMethod - Metodo não encontrado.");
		}
	 ...
	 * @param iniciandoCom - Filtro caso precise, irá obter somente os metodos que iniciem
	...
	public static void setarValorObjeto(Object entidade, String nomeAtributo, Object value) throws Exception {
		...
		if (f != null) {
			...
			throw new Exception(String.format("ReflexaoUtils.setarValorObjeto - Campo %s não encontrado na entidade %s",
