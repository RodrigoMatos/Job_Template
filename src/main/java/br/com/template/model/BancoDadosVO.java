...
public class BancoDadosVO implements Serializable {
	 ...
	 * @param Integer - Quantidade de conex�es por parti��o (em caso de utilizar pool de conex�es).
	 * @param Integer - Quantidade de parti��es (em caso de utilizar pool de conex�es).
	 * @param boolean - Valor l�gico para definir o autocommit (em caso de utilizar pool de conex�es).
	 * @param String - Comando (select) para o teste de conex�o (em caso de utilizar pool de conex�es).
	 * @author romatos
	 */
	...
	/**
	 * @author romatos
	 * @return Integer - Quantidade de conex�es por parti��es.
	 */
	...
	/**
	 * @author romatos
	 * @return Integer - Quantidade de parti��es para acesso ao banco de dados.
	 */
	...
	/**
	 * @author romatos
	 * @return Boolean - Status do commit do pool de conex�o.
	 */
