...
public abstract class ArquivoExcelGenerico implements Serializable {
	 ...
	 * @param linha       - Indice da linha.
	 * @param indexColuna - Indice da coluna que ir� escrever o valor.
	 * @param conteudo    - Conte�do Double que ser� escrito na celula.
	 * @return Retorna a celula que foi escrita.
	 */
	 ...
	 * @param linha       - Indice da linha.
	 * @param indexColuna - Indice da coluna que ir� escrever o valor.
	 * @param conteudo    - Conte�do Date que ser� escrito na celula.
	 * @return Retorna a celula que foi escrita.
	 */
	 ...
	 * @param linha       - Indice da linha.
	 * @param indexColuna - Indice da coluna que ir� escrever o valor.
	 * @param conteudo    - Conte�do Boolean que ser� escrito na celula.
	 * @return Retorna a celula que foi escrita.
	 */
	...
	/**
	 * @author romatos
	 * @param celula   - Celula que ir� escrever o valor.
	 * @param conteudo - Conte�do String que ser� escrito na celula.
	 * @return Retorna a celula que foi escrita.
	 */
	...
	/**
	 * @author romatos
	 * @param cell - Celula que ser� verificada.
	 * @return Retorna true ou false para caso a celula esteja vazia.
	 */
	public Boolean isEmptyCell(Cell cell) {
		if (cell == null || StringUtils.isEmpty(cell.toString().trim()) || cell.getCellType() == Cell.CELL_TYPE_BLANK) {
			return true;
		}
		return false;
	}
	 ...
	 * @author romatos
	 * @param cell - Celula que ser� verificada.
	 * @return Retorna o conte�do em String existente na celula.
	 */
	 ...
	 * @author romatos
	 * @param cell - Celula que ser� verificada.
	 * @return Retorna o conte�do em Date existente na celula.
	 */
	 ...
	 * @author romatos
	 * @param cell - Celula que ser� verificada.
	 * @return Retorna o conte�do em Double existente na celula.
	 */
	 ...
	 * @author romatos
	 * @param cell - Celula que ser� verificada.
	 * @return Retorna o conte�do em Long existente na celula.
	 */
