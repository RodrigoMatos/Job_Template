...
public class ArquivoExcel extends ArquivoExcelGenerico {
     ...
     * @param conteudo    - Conteudo String que será escrito na celula.
    ...
    /**
     * @throws Exception Salvar as alterações realizadas no arquivo.
     * @author romatos
     **/
    public void salvarArquivo() throws Exception {

        if (this.workbook == null) {
            LOGGER.warn("Impossivel salvar arquivo pois o workbook está nulo.");
            return;
        }
        if (this.alteracao) {
            this.fileIn.close();
